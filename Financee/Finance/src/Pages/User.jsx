...
function User() {
  ...
  return (
    ...
    <div className='users-main'>
        ...
        <button className='btn-user mt-14 delay-[300ms] duration-[600ms] text-sm  mr-64' data-aos="fade-down" onClick={openModal}>Add New User</button>
    ...
    <table className='finance-table mt-8'>
        ...
        <tbody>
          <tr  data-aos="fade-down">
            ...
            <td><button className='bg-red-900 text-white rounded-full py-2 px-8 text-sm'>Delete</button></td>
            </tr>
            <tr data-aos="fade-down">
