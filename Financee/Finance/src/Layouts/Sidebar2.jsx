  ...
  return (
    <div className='menu md:w-52 lg:w-52 px-7'>
      ...
      <div className='menu--list'>
        ...
        <Link to='/Account' className='item delay-[900ms] duration-[600ms]' data-aos="fade-down">
          <FontAwesomeIcon icon={faMoneyBill} size="" className=' icon' />
          Account
        </Link>
        <Link to='/Upload' className='item delay-[900ms] duration-[600ms]' data-aos="fade-down">
      ...
      />
      <p className=' basis-1 absolute top-4 right-8  ml-32 mt-4 '>Finance</p>
      </div>
    </div>
